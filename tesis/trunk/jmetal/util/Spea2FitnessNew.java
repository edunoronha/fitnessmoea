...
public class Spea2FitnessNew {
     ...
     */
    private double[][] distanceObj = new double[2][2];
    double cuadrante[] = new double[2];
...
// distance = distance_.distanceMatrix(solutionSet);
        distanceObj[0][1] = solutionSet.get(0).getObjective(0);
        distanceObj[1][1] = solutionSet.get(0).getObjective(1);
    ...
    public void fitnessAssign() {
        ...
        cuadrante[0] = (distanceObj[0][1] - distanceObj[0][0]) / 4;
        cuadrante[1] = (distanceObj[1][1] - distanceObj[1][0]) / 4;
...
//    } // for
    ...
    public int lugar(Object object1) {
        ...
        for (int i = 0; i < solution1.numberOfObjectives(); i++) {
            ...
            if (((value1 < distanceObj[i][1]) && (value1 > distanceObj[i][1] - cuadrante[i])) || ((value1 > distanceObj[i][0]) && (value1 < distanceObj[i][0] + cuadrante[i]))) {
                flag = 1;
            } else {
                flag = -1;
            }
