...
public class RankingNew {
   ...
   */       
  public RankingNew(SolutionSet solutionSet) {        
...
//     System.out.println(maxdistance + " maxdistance ranking");
//    System.out.println(solutionSet.get(0).getCrowdingDistance()+" distance ranking q trae de afuera");
    ...
    // of individuals that dominate me
      ...
      //  if (distance[p][q]>=maxdistance ){// solutionSet_.get(0).getCrowdingDistance()){
