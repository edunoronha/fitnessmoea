 ...
 */
public class SPEA2Cuadrante extends Algorithm {
     ...
     */
    public SPEA2Cuadrante(Problem problem) {
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        while (evaluations < maxEvaluations) {
            ...
            Spea2FitnessNew spea = new Spea2FitnessNew(union, problem_);
            spea.fitnessAssign();
            ...
            while (offSpringSolutionSet.size() < populationSize) {
                ...
                } while (j < SPEA2Cuadrante.TOURNAMENTS_ROUNDS); // do-while
                int k = 0;
                do {
                    k++;
                    parents[1] = (Solution) selectionOperator.execute(archive);
                } while (k < SPEA2Cuadrante.TOURNAMENTS_ROUNDS); // do-while
